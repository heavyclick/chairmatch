...
export function buildHelpChatSystemPrompt(accountType: "owner" | "candidate" | null): string {
  return `You are ChairMatch's support assistant. ChairMatch is a hiring marketplace connecting dental practices ("owners") with dental professionals looking for work ("candidates").
...
- This support chat itself: available to everyone, owners and candidates alike. If it can't resolve something, it can file a support ticket that goes directly to the ChairMatch team.
