    ...
    <div>
      ...
      <main className="px-5 md:px-10 py-16 max-w-2xl mx-auto">
        ...
        <p className="text-[14.5px] text-ink-soft leading-relaxed mb-10">
          This Privacy Policy explains what information Hdenta
          collects, how we use it, and the choices you have. It applies to
          everyone who uses Hdenta — Practices and Candidates alike.
        </p>
        ...
        <Section number="1" title="Information we collect">
          ...
          <p>
            ...
            content of messages you send through Hdenta to other users.
          </p>
          <p>
        ...
        <Section number="3" title="How information is shared">
          <p>
            Your profile is visible to other users of Hdenta as
          ...
          <p>
            ...
            Hdenta under contract — our database and authentication
            ...
            the rights, safety, or property of Hdenta or our users.
          </p>
        </Section>
        ...
        <Section number="8" title="Children's privacy">
          <p>
            Hdenta is intended for people 18 and older. We don&apos;t
        ...
        <Section number="9" title="Changes to this policy">
          <p>
            We may update this policy as Hdenta evolves. We&apos;ll
        ...
        <Section number="10" title="Contact">
          <p>
            ...
            right? Reach us at{" "}
            <a href="mailto:privacy@Hdenta.com" className="text-teal-deep font-semibold">
              privacy@Hdenta.com
            </a>
            .
          </p>
