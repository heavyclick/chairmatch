...
export const metadata = {
  title: "Terms of Service — ChairMatch",
};
    ...
    <div>
      ...
      <main className="px-5 md:px-10 py-16 max-w-2xl mx-auto">
        ...
        <p className="text-[14.5px] text-ink-soft leading-relaxed mb-10">
          ...
          and use of ChairMatch, a marketplace connecting independent
          dental practices (&quot;Practices,&quot; &quot;Owners&quot;) with
          dental staff seeking work (&quot;Candidates&quot;). By creating an
          account or otherwise using ChairMatch, you agree to these Terms.
          If you don&apos;t agree, don&apos;t use the service.
        </p>

        <Section number="1" title="Who can use ChairMatch">
          <p>
        ...
        <Section number="2" title="What ChairMatch is — and isn't">
          <p>
            ChairMatch is a venue for practices and dental staff to find and
        ...
        <Section number="5" title="Messaging and conduct">
          <p>
            ...
            opportunities. You agree not to use ChairMatch to harass,
          ...
          <p>
            ...
            ChairMatch to discriminate on the basis of race, color,
        ...
        <Section number="7" title="Intellectual property">
          <p>
            ...
            you grant ChairMatch a license to display it to other users as
            necessary to operate the marketplace (for example, showing a
            blurred version of your profile to a free-tier practice). The
            ChairMatch name, logo, and platform itself are our property and
        ...
        <Section number="8" title="Disclaimers">
          <p>
            ChairMatch is provided &quot;as is&quot; without warranties of
        ...
        <Section number="9" title="Limitation of liability">
          <p>
            To the maximum extent permitted by law, ChairMatch and its
        ...
        <Section number="12" title="Governing law">
          <p>
            ...
            ChairMatch is incorporated, without regard to conflict-of-law
            principles.
          </p>
        </Section>
        ...
        <Section number="13" title="Contact">
          <p>
            ...
            <a href="mailto:support@chairmatch.com" className="text-teal-deep font-semibold">
              support@chairmatch.com
            </a>
            .
          </p>
        </Section>
